...
BLOG_EMAIL = "tartley @ tartley dot com"
BLOG_DESCRIPTION = "A website devoted to oneself has been described — by my own Father, no less — as the greatest act of hubris. Welcome aboard!"  # (translatable)
...
TAG_DESCRIPTIONS = {
    DEFAULT_LANG: {
       ...
       "bash": "",
       "books": "",
       "chipmunk": "The 2D physics engine.",
       "comics": "",
       "creative": "Generating instead of consuming.",
       "draw": "Images generated by hand.",
       "ds": "Nintendo DS hand-held gaming.",
       "exhibits": "Museums & art.",
       "fiction": "",
       "fonts": "",
       "gamedev": "Creating videogames.",
       "games": "",
       "geek": "Of interest to nerds.",
       "gigs": "Live music.",
